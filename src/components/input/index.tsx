      ...
      >
        ...
        <input
          ...
          className={classNames(
            ...
            "border border-primary border-solid outline-none transition-all duration-": !disabled,
            "border border-red-500 border-solid": error,
            "cursor-not-allowed pointer-events-none bg-gray-100 border border-solid": disabled,
          })}
        />
